...
function analyzeFile(filePath) {
  ...
  if (metrics.nestingDepth > limits.nestingDepth) {
    violations.push(`Nesting too deep: ${metrics.nestingDepth} levels (max: ${limits.nestingDepth})`);
  }

  if (metrics.cyclomaticComplexity > limits.cyclomaticComplexity) {
    violations.push(`Cyclomatic complexity too high: ${metrics.cyclomaticComplexity} (max: ${limits.cyclomaticComplexity})`);
  }
